  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start mx-6 md:mx-16 lg:mx-24 mt-10 md:mt-16">
        ...
        <span className="mt-2 text-lg md:text-xl hover:text-blue-300 font-medium">Welcome! Md Rimel</span>
      </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between px-6 md:px-16 lg:px-24 mt-8 md:mt-12 gap-8">
        ...
        <div className="flex flex-col gap-8 w-full lg:w-1/3">
          ...
          <div className="flex flex-col items-start">
            <h1 className="text-lg font-semibold text-gray-700 hover:text-yellow-400 mb-3">Manage My Account</h1>
        ...
        <div className="w-full lg:w-2/3 bg-white p-6 md:p-8 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input
                type="email"
                placeholder="awanareeba40@gmail.com"
                className="bg-gray-100 p-3 w-full rounded-md border focus:outline-none focus:ring-2 focus:ring-red-300"
              />
            </div>
            <div>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-4">
            ...
            <button className="px-6 py-3 bg-[#DB4444] text-white rounded-md hover:bg-red-950 w-full sm:w-auto">
              Save Changes
            </button>
          </div>
        </div>
